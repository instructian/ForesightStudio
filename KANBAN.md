...
| [ ] **M4.3: Controlled Vocabularies** <br> *`geography`/`sector` free-text fragments aggregation; add lookup tables or ISO codes plus GIN index on tags.* | | | [x] **M2.5: Lock Verified Signal Content** <br> *Done in migration 20260707100002: student UPDATE policy requires `verification <> 'Verified'` in USING and WITH CHECK.* |
